...
if ($TERM =~ '256' || &t_Co >= 256) || has("gui_running")
    ...
    hi MatchParen ctermbg=235 ctermfg=13 cterm=NONE guibg=#262626 guifg=#ff00ff gui=NONE
    ...
    hi Search ctermbg=186 ctermfg=234 cterm=NONE guibg=#d7d787 guifg=#1c1c1c gui=NONE
...
elseif &t_Co == 8 || $TERM !~# '^linux' || &t_Co == 16
    ...
    hi MatchParen ctermbg=black ctermfg=magenta cterm=NONE
    ...
    hi Search ctermbg=lightgoldenrod2 ctermfg=black cterm=NONE
